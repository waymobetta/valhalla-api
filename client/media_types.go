...
// DecodeGodkjent decodes the Godkjent instance encoded in resp body.
func (c *Client) DecodeGodkjent(resp *http.Response) (*Godkjent, error) {
	var decoded Godkjent
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeGodkjentCollection decodes the GodkjentCollection instance encoded in resp body.
func (c *Client) DecodeGodkjentCollection(resp *http.Response) (GodkjentCollection, error) {
	var decoded GodkjentCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
...
// DecodeGodkjentliste decodes the Godkjentliste instance encoded in resp body.
func (c *Client) DecodeGodkjentliste(resp *http.Response) (*Godkjentliste, error) {
	var decoded Godkjentliste
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeHelse decodes the Helse instance encoded in resp body.
func (c *Client) DecodeHelse(resp *http.Response) (*Helse, error) {
	var decoded Helse
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
